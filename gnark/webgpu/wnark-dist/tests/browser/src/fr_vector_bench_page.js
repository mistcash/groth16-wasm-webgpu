import { appendAdapterDiagnostics, createPageUI, fetchText, mustElement, } from "../../../src/curvegpu/browser_utils.js";
...
async function runFullPathBenchmark(device, kernel, inputA, inputB, opcode, logCount) {
