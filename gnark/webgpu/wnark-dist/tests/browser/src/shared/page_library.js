...
export function getRequestedCurveId(search = window.location.search) {
...
export function appendContextDiagnostics(lines, context) {
...
export async function createRequestedCurveModule(curve = getRequestedCurveId()) {
