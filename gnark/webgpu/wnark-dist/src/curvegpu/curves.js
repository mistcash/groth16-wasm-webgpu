...
function g1OpsShaderParts(fpArithShaderPath, g1IOPath) {
    return [
...
function g1MSMShaderParts(fpArithShaderPath, g1IOPath) {
    return [
        `${fpArithShaderPath}#section=fp-types`,
        `${fpArithShaderPath}#section=fp-consts`,
        `${fpArithShaderPath}#section=fp-core`,
...
function g2OpsShaderParts(fpArithShaderPath, g2ArithPath, g2IOPath) {
    return [
        `${fpArithShaderPath}#section=fp-types`,
        `${fpArithShaderPath}#section=fp-consts`,
        `${fpArithShaderPath}#section=fp-core`,
...
function g2MSMShaderParts(fpArithShaderPath, g2ArithPath, g2IOPath) {
    return [
        `${fpArithShaderPath}#section=fp-types`,
        `${fpArithShaderPath}#section=fp-consts`,
        `${fpArithShaderPath}#section=fp-core`,
...
const CURVE_DEFINITIONS = {
    bn254: {
        ...
        frNTTDomainPath: "./vectors/bn254_ntt_domains.json",
    ...
    bls12_381: {
        ...
        frNTTDomainPath: "./vectors/bls12_381_ntt_domains.json",
    ...
    bls12_377: {
        ...
        frNTTDomainPath: "./vectors/bls12_377_ntt_domains.json",
 ...
 */
export const supportedCurveIds = Object.freeze(Object.keys(CURVE_DEFINITIONS));
/**
 * Return the runtime metadata for a supported curve.
 */
export function curveDefinition(curve) {
 ...
 */
export async function createCurveModule(context, curve) {
    ...
    const g1 = createG1Module(context, {
        curve: definition.id,
    ...
    const g2 = createG2Module(context, {
        curve: definition.id,
    ...
    const ntt = createNTTModule(context, {
        curve: definition.id,
    ...
    const g1msm = createG1MSMModule(context, {
        curve: definition.id,
        coordinateBytes: definition.coordinateBytes,
        pointBytes: definition.pointBytes,
        runtime: g1MsmRuntime,
    }, fp, g1);
    const g2msm = createG2MSMModule(context, {
        curve: definition.id,
        componentBytes: fpShape.byteSize,
        pointBytes: definition.g2PointBytes,
