...
export interface Groth16Module extends Groth16QuotientModule {
     ...
     */
    loadRuntime(options?: Groth16RuntimeOptions & {
    ...
    readProvingKey(bytes: Uint8Array, options?: {
        format?: Groth16ProvingKeyFormat;
    }): Promise<Groth16ProvingKey>;
     ...
     */
    encodeWitness(values: readonly bigint[], options: {
        publicCount: number;
    }): Uint8Array;
}
...
export interface PlonkModule {
     ...
     * when serving the runtime from an application asset path or CDN.
     */
    loadRuntime(options?: PlonkRuntimeOptions & {
    ...
    readProvingKey(bytes: Uint8Array, options?: {
        format?: PlonkProvingKeyFormat;
    }): Promise<PlonkProvingKey>;
...
export interface G1MSMModule {
    ...
    pippengerAffine(bases: readonly CurveGPUAffinePoint[], scalars: readonly CurveGPUElementBytes[], options?: CurveGPUMSMOptions): Promise<CurveGPUJacobianPoint>;
    /** Run a single affine-base Pippenger MSM and return the result in affine form. */
    pippengerAffineResult(bases: readonly CurveGPUAffinePoint[], scalars: readonly CurveGPUElementBytes[], options?: CurveGPUMSMOptions): Promise<CurveGPUAffinePoint>;
    /**
     ...
     */
    pippengerAffineBatch(bases: readonly CurveGPUAffinePoint[], scalars: readonly CurveGPUElementBytes[], options: CurveGPUMSMOptions): Promise<CurveGPUJacobianPoint[]>;
    /**
     ...
     */
    pippengerPackedJacobianBases(basesPacked: Uint8Array, scalarsPacked: Uint8Array, options: CurveGPUMSMOptions & {
        layout?: CurveGPUPackedPointLayout;
    }): Promise<Uint8Array>;
}
/**
...
export interface G2MSMModule {
    ...
    pippengerAffine(bases: readonly CurveGPUG2AffinePoint[], scalars: readonly CurveGPUElementBytes[], options?: CurveGPUMSMOptions): Promise<CurveGPUG2JacobianPoint>;
    /** Run a single affine-base G2 Pippenger MSM and return the result in affine form. */
    pippengerAffineResult(bases: readonly CurveGPUG2AffinePoint[], scalars: readonly CurveGPUElementBytes[], options?: CurveGPUMSMOptions): Promise<CurveGPUG2AffinePoint>;
    /**
     ...
     * `options.count` and `options.termsPerInstance` must both be provided.
     */
    pippengerAffineBatch(bases: readonly CurveGPUG2AffinePoint[], scalars: readonly CurveGPUElementBytes[], options: CurveGPUMSMOptions): Promise<CurveGPUG2JacobianPoint[]>;
    /**
