...
export function bestPippengerWindow(count) {
...
export function hexesToScalarWords(hexes) {
...
export function makeRandomScalarBatch(count, salt = 0x9e3779b9) {
...
export function buildSparseSignedBucketMetadataWords(scalarWords, count, termsPerInstance, window, maxChunkSize = 256) {
...
function extractWindowDigitWords(words, scalarBase, bitOffset, window) {
    if (window <= 0) {
        return 0;
    }
...
function makeRandomScalarData(seed) {
